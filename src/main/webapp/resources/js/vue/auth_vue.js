...
auth_vue = (()=>{
	return{
		login_body : () => {
			return '<form id="form_join" class="form-main">'+
		...
		'            <input id="uid" type="text" class="form-control" placeholder="" required="">'+
		...
		'            <input id="upw" type="text" class="form-control" placeholder="" required="">'+
		'            <div class="invalid-feedback">'+
